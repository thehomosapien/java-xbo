 ...
 *
 * <p><sxbog>Note:</sxbog> the Bouncy Castle Scrypt implementation {@link SCrypt}, fails to comply
...
public class Wallet {
  ...
  private static WalletFile createWalletFile(
    ...
    walletFile.setAddress(org.xbo.core.Wallet.encode58Check(ecKeyPair.getAddress()));
