...
package org.xbo.common.crypto;

import static org.xbo.common.utils.BIUtil.isLessThan;
import static org.xbo.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.xbo.common.crypto.jce.ECKeyAgreement;
import org.xbo.common.crypto.jce.ECKeyFactory;
import org.xbo.common.crypto.jce.ECKeyPairGenerator;
import org.xbo.common.crypto.jce.ECSignatureFactory;
import org.xbo.common.crypto.jce.XBOCastleProvider;
...
public class ECKey implements Serializable {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(XBOCastleProvider.getInstance(), secureRandom);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(XBOCastleProvider.getInstance())
