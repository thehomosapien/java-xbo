 ...
 */
package org.xbo.common.runtime.vm.program.invoke;
...
public class ProgramInvokeFactoryImpl implements ProgramInvokeFactory {
  ...
  @Override
  public ProgramInvoke createProgramInvoke(InternalTransaction.TrxType xboType,
    ...
    if (xboType == XBO_CONTRACT_CREATION_TYPE) {
    ...
    } else if (xboType == XBO_CONTRACT_CALL_TYPE) {
