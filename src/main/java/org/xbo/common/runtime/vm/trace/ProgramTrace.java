 ...
 */
package org.xbo.common.runtime.vm.trace;

import static java.lang.String.format;
import static org.xbo.common.runtime.utils.MUtil.convertToXBOAddress;
import static org.xbo.common.runtime.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
  ...
  public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
    if (programInvoke != null && config.vmTrace()) {
      contractAddress = Hex
          .toHexString(convertToXBOAddress(programInvoke.getContractAddress().getLast20Bytes()));
    }
  }
