...
import org.xbo.common.runtime.vm.program.listener.ProgramListener;
import org.xbo.common.runtime.vm.program.listener.ProgramListenerAware;
import org.xbo.common.storage.Deposit;
import org.xbo.common.storage.Key;
import org.xbo.common.storage.Value;
...
public class ContractState implements Deposit, ProgramListenerAware {
  ...
  public TransactionCapsule getTransaction(byte[] xboHash) {
    return this.deposit.getTransaction(xboHash);
  }
