...
import static org.xbo.common.utils.BIUtil.addSafely;
import static org.xbo.common.utils.BIUtil.isLessThan;
import static org.xbo.common.utils.BIUtil.isZero;
import static org.xbo.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.xbo.common.utils.ByteUtil.bytesToBigInteger;
import static org.xbo.common.utils.ByteUtil.numberOfLeadingZeros;
import static org.xbo.common.utils.ByteUtil.parseBytes;
import static org.xbo.common.utils.ByteUtil.parseWord;
...
import org.xbo.common.crypto.zksnark.BN128;
import org.xbo.common.crypto.zksnark.BN128Fp;
import org.xbo.common.crypto.zksnark.BN128G1;
import org.xbo.common.crypto.zksnark.BN128G2;
import org.xbo.common.crypto.zksnark.Fp;
import org.xbo.common.crypto.zksnark.PairingCheck;
import org.xbo.common.runtime.config.VMConfig;
import org.xbo.common.runtime.utils.MUtil;
import org.xbo.common.runtime.vm.program.Program;
import org.xbo.common.runtime.vm.program.ProgramResult;
import org.xbo.common.storage.Deposit;
import org.xbo.common.utils.BIUtil;
...
import org.xbo.core.actuator.ProposalApproveActuator;
import org.xbo.core.actuator.ProposalCreateActuator;
import org.xbo.core.actuator.ProposalDeleteActuator;
import org.xbo.core.actuator.VoteWitnessActuator;
import org.xbo.core.actuator.WithdrawBalanceActuator;
...
import org.xbo.protos.Contract.ProposalApproveContract;
import org.xbo.protos.Contract.ProposalCreateContract;
import org.xbo.protos.Contract.ProposalDeleteContract;
import org.xbo.protos.Contract.VoteWitnessContract;
import org.xbo.protos.Contract.WithdrawBalanceContract;
...
//  private static final ConvertFromXBOBytesAddressNative convertFromXBOBytesAddress = new ConvertFromXBOBytesAddressNative();
//  private static final ConvertFromXBOBase58AddressNative convertFromXBOBase58Address = new ConvertFromXBOBase58AddressNative();
...
//  private static final GetTransferAssetNative getTransferAssetAmount =  new GetTransferAssetNative();
  ...
  public static class VoteWitnessNative extends PrecompiledContract {
    ...
    @Override
    // TODO: Please re-implement this function after XBO cost is well designed.
    public long getEnergyForData(byte[] data) {
      return 200;
    }
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      voteBuilder.setVoteAddress(ByteString.copyFrom(convertToXBOAddress(witnessAddress20)));
...
//
//      TransactionCapsule xbo = new TransactionCapsule(contract, ContractType.FreezeBalanceContract);
//
//      final List<Actuator> actuatorList = ActuatorFactory
//          .createActuator(xbo, getDeposit().getDbManager());
//      try {
...
//
//      TransactionCapsule xbo = new TransactionCapsule(contract,
...
//      }
  ...
  /**
   * Native function for converting bytes32 xbo address to solidity address type value. <br/>
   * <br/>
   *
   * Input data[]: <br/> bytes32 xbo address <br/>
   *
   * Output: <br/> Solidity address <br/>
   */
  public static class ConvertFromXBOBytesAddressNative extends PrecompiledContract {
  ...
  /**
   * Native function for converting Base58String xbo address to solidity address type value. <br/>
   * <br/>
   *
   * Input data[]: <br/> Base58String xbo address <br/>
   *
   * Output: <br/> Solidity address <br/>
   */
  public static class ConvertFromXBOBase58AddressNative extends PrecompiledContract {
...
//          .newBuilder();
//      builder.setOwnerAddress(ByteString.copyFrom(getCallerAddress()));
//      builder.setToAddress(ByteString.copyFrom(convertToXBOAddress(new DataWord(toAddress).getLast20Bytes())));
...
//      }
  ...
  public static class GetTransferAssetNative extends PrecompiledContract {
    ...
    public Pair<Boolean, byte[]> execute(byte[] data) {
      ...
      long assetBalance = this.getDeposit().
          getAccount(convertToXBOAddress(new DataWord(targetAddress).getLast20Bytes())).
  ...
  public static class MultiValidateSign extends PrecompiledContract {
    ...
    private static final byte[] ZEROADDR = MUtil.allZero32XBOAddress();
