package org.xbo.common.overlay.client;
...
import org.xbo.common.overlay.server.XBOChannelInitializer;
...
public class PeerClient {
  ...
  public PeerClient() {
    workerGroup = new NioEventLoopGroup(0, new ThreadFactory() {
      ...
      public Thread newThread(Runnable r) {
        return new Thread(r, "XBOJClientWorker-" + cnt.getAndIncrement());
      }
    });
  }
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    XBOChannelInitializer xboChannelInitializer = ctx
        .getBean(XBOChannelInitializer.class, remoteId);
    xboChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(xboChannelInitializer);
