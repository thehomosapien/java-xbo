...
import org.xbo.common.overlay.message.MessageCodec;
import org.xbo.common.overlay.message.StaticMessages;
import org.xbo.core.db.ByteArrayWrapper;
import org.xbo.core.exception.P2pException;
import org.xbo.core.net.XBONetHandler;
...
public class Channel {
  ...
  @Autowired
  private XBONetHandler xboNetHandler;
  ...
  private XBOState xboState = XBOState.INIT;
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    xboNetHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    xboNetHandler.setMsgQueue(msgQueue);
  }
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", xboNetHandler);
    setStartTime(msg.getTimestamp());
    setXBOState(XBOState.HANDSHAKE_FINISHED);
  ...
  public void setXBOState(XBOState xboState) {
    this.xboState = xboState;
    logger.info("Peer {} status change to {}.", inetSocketAddress, xboState);
  }
