...
import org.xbo.common.overlay.message.PingMessage;
import org.xbo.common.overlay.message.PongMessage;
...
public class MessageQueue {
  ...
  private boolean needToLog(Message msg) {
    ...
    if (msg instanceof InventoryMessage &&
        ((InventoryMessage) msg).getInventoryType().equals(InventoryType.XBO)) {
      return false;
    }
