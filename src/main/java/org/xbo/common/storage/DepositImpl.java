...
import org.xbo.common.runtime.vm.program.Storage;
...
import org.xbo.core.db.CodeStore;
import org.xbo.core.db.ContractStore;
import org.xbo.core.db.DelegatedResourceStore;
import org.xbo.core.db.DynamicPropertiesStore;
import org.xbo.core.db.Manager;
import org.xbo.core.db.ProposalStore;
import org.xbo.core.db.TransactionStore;
import org.xbo.core.db.VotesStore;
import org.xbo.core.db.WitnessStore;
...
public class DepositImpl implements Deposit {
  ...
  public synchronized void putStorageValue(byte[] address, DataWord key, DataWord value) {
    address = convertToXBOAddress(address);
...
//    accountCapsule.addAssetAmount(tokenIdWithoutLeadingZero, value);
  ...
  @Override
  public TransactionCapsule getTransaction(byte[] xboHash) {
    Key key = Key.create(xboHash);
    ...
    if (parent != null) {
      transactionCapsule = parent.getTransaction(xboHash);
    } else {
      try {
        transactionCapsule = getTransactionStore().get(xboHash);
