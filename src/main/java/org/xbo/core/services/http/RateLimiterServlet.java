...
import org.xbo.core.config.args.RateLimiterInitialization;
import org.xbo.core.services.ratelimiter.RateLimiterContainer;
import org.xbo.core.services.ratelimiter.RuntimeData;
import org.xbo.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.xbo.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.xbo.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.xbo.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.xbo.core.services.ratelimiter.adapter.IRateLimiter;
import org.xbo.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;

@Slf4j
public abstract class RateLimiterServlet extends HttpServlet {

  private static final String KEY_PREFIX_HTTP = "http_";
  private static final String ADAPTER_PREFIX = "org.xbo.core.services.ratelimiter.adapter.";
