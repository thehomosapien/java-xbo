...
import org.xbo.common.entity.NodeInfo.ConfigNodeInfo;
import org.xbo.common.entity.NodeInfo.MachineInfo;
import org.xbo.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.xbo.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.xbo.common.entity.PeerInfo;
...
import org.xbo.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getXBOLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getXBOLastRemoteDisconnectReason();
