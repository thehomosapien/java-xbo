...
import org.xbo.common.overlay.discover.node.statistics.NodeStatistics.SimpleStatter;
...
public class PeerConnection extends Channel {
  ...
  public void onConnect() {
    if (getHelloMessage().getHeadBlockId().getNum() > xboNetDelegate.getHeadBlockId().getNum()) {
      setXBOState(XBOState.SYNCING);
      syncService.startSync(this);
    } else {
      setXBOState(XBOState.SYNC_COMPLETED);
    }
  }
