...
import org.xbo.common.overlay.message.MessageFactory;
import org.xbo.core.exception.P2pException;

/**
 * msg factory.
 */
public class XBOMessageFactory extends MessageFactory {

  @Override
  public XBOMessage create(byte[] data) throws Exception {
    try {
      byte type = data[0];
  ...
  private XBOMessage create(byte type, byte[] packed) throws Exception {
