...
public class XBONetDelegate {
  ...
  public boolean contain(Sha256Hash hash, MessageTypes type) {
    ...
    } else if (type.equals(MessageTypes.XBO)) {
  ...
  public void pushTransaction(TransactionCapsule xbo) throws P2pException {
    try {
      dbManager.pushTransaction(xbo);
    } catch (ContractSizeNotEqualToOneException
        | VMIllegalException e) {
      throw new P2pException(TypeEnum.BAD_XBO, e);
      ...
      throw new P2pException(TypeEnum.XBO_EXE_FAILED, e);
    }
  }
