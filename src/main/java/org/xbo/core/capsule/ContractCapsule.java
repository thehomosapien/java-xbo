...
public class ContractCapsule implements ProtoCapsule<SmartContract> {
  ...
  public static CreateSmartContract getSmartContractFromTransaction(Transaction xbo) {
    try {
      Any any = xbo.getRawData().getContract(0).getParameter();
  ...
  public static TriggerSmartContract getTriggerContractFromTransaction(Transaction xbo) {
    try {
      Any any = xbo.getRawData().getContract(0).getParameter();
