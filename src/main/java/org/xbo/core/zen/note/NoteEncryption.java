package org.xbo.core.zen.note;

import static org.xbo.common.zksnark.JLibsodium.crypto_aead_chacha20poly1305_IETF_NPUBBYTES;
import static org.xbo.core.zen.note.NoteEncryption.Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE;
import static org.xbo.core.zen.note.ZenChainParams.ZC_ENCCIPHERTEXT_SIZE;
import static org.xbo.core.zen.note.ZenChainParams.ZC_ENCPLAINTEXT_SIZE;
import static org.xbo.core.zen.note.ZenChainParams.ZC_OUTCIPHERTEXT_SIZE;
import static org.xbo.core.zen.note.ZenChainParams.ZC_OUTPLAINTEXT_SIZE;
...
import org.xbo.common.zksnark.LibrustzcashParam.KaAgreeParams;
import org.xbo.common.zksnark.LibrustzcashParam.KaDerivepublicParams;
...
import org.xbo.core.zen.note.NoteEncryption.Encryption.EncCiphertext;
import org.xbo.core.zen.note.NoteEncryption.Encryption.EncPlaintext;
import org.xbo.core.zen.note.NoteEncryption.Encryption.OutCiphertext;
import org.xbo.core.zen.note.NoteEncryption.Encryption.OutPlaintext;
...
public class NoteEncryption {
  ...
  public static class Encryption {
    ...
    public static void prfOck(byte[] ock, byte[] ovk, byte[] cv, byte[] cm, byte[] epk)
      ...
      byte[] temp = "Zxbo_Derive_ock".getBytes();
    ...
    public static void kdfSapling(byte[] kEnc, byte[] sharedsecret, byte[] epk) throws ZksnarkException {
      ...
      byte[] personalization = new byte[JLibsodium.crypto_generichash_blake2b_PERSONALBYTES];
      byte[] temp = "Zxbo_SaplingKDF".getBytes();
      System.arraycopy(temp, 0, personalization, 0, temp.length);
