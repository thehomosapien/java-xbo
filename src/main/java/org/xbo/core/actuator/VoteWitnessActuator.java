...
import static org.xbo.core.actuator.ActuatorConstant.ACCOUNT_EXCEPTION_STR;
import static org.xbo.core.actuator.ActuatorConstant.NOT_EXIST_STR;
import static org.xbo.core.actuator.ActuatorConstant.WITNESS_EXCEPTION_STR;
...
public class VoteWitnessActuator extends AbstractActuator {
  ...
  public boolean validate() throws ContractValidateException {
    ...
    try {
      ...
      long xboPower = accountCapsule.getXBOPower();

      sum = LongMath.checkedMultiply(sum, 1000000L); //xbo -> drop. The vote count is based on XBO
      if (sum > xboPower) {
        throw new ContractValidateException(
            "The total number of votes[" + sum + "] is greater than the xboPower[" + xboPower
                + "]");
      }
