...
import org.xbo.core.capsule.utils.TransactionUtil;
...
import org.xbo.protos.Protocol.Account.Frozen;
...
//      assetIssueCapsule.setOrder(order);
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (dbManager.getDynamicPropertiesStore().getAllowSameTokenName() != 0) {
      ...
      if (name.equals("xbo")) {
        throw new ContractValidateException("assetName can't be xbo");
      }
    }
