...
@Slf4j(topic = "DB")
@Component
public class DynamicPropertiesStore extends XBOStoreWithRevoking<BytesCapsule> {
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      ...
      this.saveCreateAccountFee(100_000L); // 0.1XBO
    }
  ...
  public void saveTotalStoragePool(long xbo) {
    this.put(TOTAL_STORAGE_POOL,
        new BytesCapsule(ByteArray.fromLong(xbo)));
  }
  ...
  public void saveTotalStorageTax(long xbo) {
