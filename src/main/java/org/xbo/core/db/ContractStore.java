...
@Slf4j(topic = "DB")
@Component
public class ContractStore extends XBOStoreWithRevoking<ContractCapsule> {
   ...
   */
  public byte[] findContractByHash(byte[] xboHash) {
    return revokingDB.getUnchecked(xboHash);
  }
