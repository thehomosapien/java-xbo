...
import org.xbo.core.db.api.index.Index.Iface;
import org.xbo.core.db.common.WrappedByteArray;
import org.xbo.core.db.common.WrappedResultSet;
...
public abstract class AbstractIndex<E extends ProtoCapsule<T>, T> implements Iface<T> {
  ...
  protected IXBOChainBase<E> database;
  ...
  public AbstractIndex(IXBOChainBase<E> database) {
