...
public class AccountVoteWitnessTest {
  ...
  private List<AccountCapsule> getAccountList() {
    ...
    final AccountCapsule accountXBO =
        new AccountCapsule(
            ByteString.copyFrom("00000000001".getBytes()),
            ByteString.copyFromUtf8("XBO"),
            AccountType.Normal);
    ...
    final AccountCapsule accountVivider =
        new AccountCapsule(
            ...
            AccountType.Normal);
    // accountXBO addVotes
    accountXBO.addVotes(accountMarcus.getAddress(), 100);
    accountXBO.addVotes(accountOlivier.getAddress(), 100);
    accountXBO.addVotes(accountSasaXie.getAddress(), 100);
    accountXBO.addVotes(accountVivider.getAddress(), 100);

    // accountMarcus addVotes
    accountMarcus.addVotes(accountXBO.getAddress(), 100);
    ...
    accountOlivier.addVotes(accountXBO.getAddress(), 100);
    ...
    accountCapsuleList.add(accountXBO);
  ...
  private List<WitnessCapsule> getWitnessList() {
    ...
    final WitnessCapsule witnessXBO =
    ...
    witnessCapsuleList.add(witnessXBO);
