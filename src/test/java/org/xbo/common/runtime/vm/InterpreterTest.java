...
import org.xbo.common.runtime.vm.program.invoke.ProgramInvokeMockImpl;
...
public class InterpreterTest {
  ...
  public void testVMException() throws ContractValidateException {
    ...
    // 0x60 0x00 - PUSH 0x00
    // 0x56      - JUMP to 0
    Transaction xbo = Transaction.getDefaultInstance();
    InternalTransaction interTrx = new InternalTransaction(xbo, TrxType.XBO_UNKNOWN_TYPE);
