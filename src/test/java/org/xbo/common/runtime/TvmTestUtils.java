...
public class TvmTestUtils {
  ...
  public static byte[] deployContractWholeProcessReturnContractAddress(String contractName,
    ...
    Transaction xbo = generateDeploySmartContractAndGetTransaction(contractName, callerAddress, abi,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);
    processTransactionAndReturnRuntime(xbo, deposit, block);
    return Wallet.generateContractAddress(xbo);
  }
  ...
  public static Runtime triggerContractWholeProcessReturnContractAddress(byte[] callerAddress,
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction xbo = generateTriggerSmartContractAndGetTransaction(callerAddress, contractAddress,
        data, callValue, feeLimit);
    return processTransactionAndReturnRuntime(xbo, deposit, block);
  }
  ...
  public static Transaction generateDeploySmartContractAndGetTransaction(String contractName,
    ...
    TransactionCapsule xboCapWithoutFeeLimit = new TransactionCapsule(contract,
        ContractType.CreateSmartContract);
    Transaction.Builder transactionBuilder = xboCapWithoutFeeLimit.getInstance().toBuilder();

    Transaction.raw.Builder rawBuilder = xboCapWithoutFeeLimit.getInstance().getRawData()
        .toBuilder();
    rawBuilder.setFeeLimit(feeLimit);
    transactionBuilder.setRawData(rawBuilder);
    Transaction xbo = transactionBuilder.build();
    return xbo;
  }
  ...
  public static Runtime processTransactionAndReturnRuntime(Transaction xbo,
      Deposit deposit, BlockCapsule block)
      throws ContractExeException, ContractValidateException,
      ReceiptCheckErrException, VMIllegalException {
    TransactionCapsule xboCap = new TransactionCapsule(xbo);
    deposit.commit();
    TransactionTrace trace = new TransactionTrace(xboCap, deposit.getDbManager());
    // init
    trace.init(block);
    //exec
    trace.exec();
  ...
  public static TransactionTrace processTransactionAndReturnTrace(Transaction xbo,
  ...
  public static TVMTestResult deployContractAndReturnTvmTestResult(String contractName,
    ...
    return processTransactionAndReturnTvmTestResult(xbo, dbManager, blockCap)
        .setContractAddress(Wallet.generateContractAddress(xbo));
  }
  ...
  public static TVMTestResult deployContractWithCreatorEnergyLimitAndReturnTvmTestResult(
      ...
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    Transaction xbo = generateDeploySmartContractWithCreatorEnergyLimitAndGetTransaction(
  ...
  public static TVMTestResult processTransactionAndReturnTvmTestResult(Transaction xbo,
