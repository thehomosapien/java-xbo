...
import static org.xbo.common.runtime.TvmTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.xbo.common.runtime.TvmTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveTotalEnergyWeight(5_000_000_000L); // unit is xbo
  ...
  public void getCreatorEnergyLimit2Test() {
    ...
    Transaction xbo = generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);

    RuntimeImpl runtimeImpl = new RuntimeImpl(xbo, null, deposit, new ProgramInvokeFactoryImpl(),
        true);
