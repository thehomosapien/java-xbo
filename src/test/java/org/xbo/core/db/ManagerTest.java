...
import org.xbo.protos.Protocol.BlockHeader;
import org.xbo.protos.Protocol.BlockHeader.raw;
...
public class ManagerTest {
  ...
  public void setBlockReference()
    ...
    if (dbManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      dbManager.setBlockReference(xbo);
      Assert.assertEquals(1,
          ByteArray.toInt(xbo.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void updateWits() {
    ...
    WitnessCapsule witnessCapsulef =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0011")), "www.xbo.net/first");
    witnessCapsulef.setIsJobs(true);
    WitnessCapsule witnessCapsules =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0012")), "www.xbo.net/second");
    witnessCapsules.setIsJobs(true);
    WitnessCapsule witnessCapsulet =
        new WitnessCapsule(
            ByteString.copyFrom(ByteArray.fromHexString("0x0013")), "www.xbo.net/three");
