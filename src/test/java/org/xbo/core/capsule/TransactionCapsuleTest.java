...
//    Transaction.Builder xboBuilder = Transaction.newBuilder();
...
//    xboBuilder.setRawData(rawBuilder);
//    AccountStore accountStore = dbManager.getAccountStore();
//    TransactionCapsule transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    //Accout not exist
//    try {
...
//    //SignatureFormatException
//    ByteString test = ByteString.copyFromUtf8("test");
//    xboBuilder.clearSignature().addSignature(test);
//    try {
//      TransactionCapsule.validateSignature(xboBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (PermissionException e) {
...
//    new Random().nextBytes(rand);
//    rand[64] = 8;  // v = 8 < 27 v += 35 > 35
//    xboBuilder.clearSignature().addSignature(ByteString.copyFrom(rand));
//    try {
//      TransactionCapsule.validateSignature(xboBuilder.build(), hash,
//          accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertEquals(e.getMessage(), "Header byte out of range: 35");
...
//    xboBuilder.clearSignature().addAllSignature(sign21_11);
//    try {
//      TransactionCapsule.validateSignature(xboBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
...
//    xboBuilder.clearSignature().addAllSignature(sign21_11_22_23);
//    try {
//      TransactionCapsule
//          .validateSignature(xboBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
//    } catch (SignatureException e) {
//      Assert.assertFalse(true);
//    } catch (PermissionException e) {
...
//    xboBuilder.clearSignature().addAllSignature(sign21_22_21);
//    try {
//      TransactionCapsule
//          .validateSignature(xboBuilder.build(), hash, accountStore);
//      Assert.assertFalse(true);
...
//    xboBuilder.clearSignature().addAllSignature(sign21);
//    try {
...
//    xboBuilder.clearSignature().addAllSignature(sign21_22);
//    try {
//      boolean result = TransactionCapsule
//          .validateSignature(xboBuilder.build(), hash, accountStore);
...
//    xboBuilder.clearSignature().addAllSignature(sign21_22_23);
//    try {
//      boolean result = TransactionCapsule
//          .validateSignature(xboBuilder.build(), hash, accountStore);
//      Assert.assertTrue(result);
...
//    ArrayList<ByteString> sign = sign(prikeys, Sha256Hash.hash(rawBuilder.build().toByteArray()));
//    xboBuilder.addAllSignature(sign);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//
//    // no contract
//    prikeys.clear();
//    prikeys.add(ByteArray.fromHexString(KEY_21));
//    xboBuilder = Transaction.newBuilder();
...
//    xboBuilder = transactionCapsule.getInstance().toBuilder();
//    //SignatureFormatException
//    ByteString test = ByteString.copyFromUtf8("test");
//    xboBuilder.clearSignature();
//    xboBuilder.addSignature(test);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    rand[64] = 8;  // v = 8 < 27 v += 35 > 35
//    xboBuilder.clearSignature();
//    xboBuilder.addSignature(ByteString.copyFrom(rand));
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_11 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21_11);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_11_22_23 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21_11_22_23);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_22_21 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21_22_21);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      transactionCapsule.validateSignature(dbManager);
//      Assert.assertFalse(true);
...
//    ArrayList<ByteString> sign21_22 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21_22);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
...
//    ArrayList<ByteString> sign21_22_23 = sign(prikeys, hash);
//    xboBuilder.clearSignature();
//    xboBuilder.addAllSignature(sign21_22_23);
//    transactionCapsule = new TransactionCapsule(xboBuilder.build());
//    try {
//      boolean result = transactionCapsule.validateSignature(dbManager);
//      Assert.assertTrue(result);
