...
import org.xbo.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.xbo.protos.Protocol.ReasonCode getReason() {
    org.xbo.protos.Protocol.ReasonCode result = org.xbo.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.xbo.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.xbo.protos.Protocol.ReasonCode getName() {
    org.xbo.protos.Protocol.ReasonCode result = org.xbo.protos.Protocol.ReasonCode
        .valueOf(name_);
    return result == null ? org.xbo.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (reason_ != org.xbo.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.xbo.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
