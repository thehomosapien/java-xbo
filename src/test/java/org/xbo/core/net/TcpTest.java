...
import static org.xbo.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.xbo.core.net.message.MessageTypes.P2P_HELLO;
import static org.xbo.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.xbo.protos.Protocol.ReasonCode.FORKED;
import static org.xbo.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.xbo.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.xbo.common.overlay.message.DisconnectMessage;
import org.xbo.common.overlay.message.HelloMessage;
import org.xbo.common.overlay.message.Message;
import org.xbo.common.overlay.message.P2pMessage;
import org.xbo.common.overlay.message.P2pMessageFactory;
import org.xbo.common.overlay.server.ChannelManager;
import org.xbo.common.overlay.server.SyncPool;
import org.xbo.common.utils.ReflectUtils;
...
public class TcpTest {
  ...
  public TcpTest(XBOApplicationContext context) {
    channelManager = context.getBean(ChannelManager.class);
    manager = context.getBean(Manager.class);
    pool = context.getBean(SyncPool.class);
    xboNetDelegate = context.getBean(XBONetDelegate.class);
  }
  ...
  private void validResultCloseConnect(Channel channel) throws InterruptedException {
    ...
    Collection<PeerConnection> peerConnections = ReflectUtils
        .invokeMethod(xboNetDelegate, "getActivePeer");
