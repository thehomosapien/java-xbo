...
public class SaplingNoteTest {
  ...
  public void testVectors() throws ZksnarkException {
    ...
    byte[] sk = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        0x00, 0x00, 0x00, 0x00};
    byte[] pkD = {
        (byte) 0xdb, 0x4c, (byte) 0xd2, (byte) 0xb0, (byte) 0xaa, (byte) 0xc4, (byte) 0xf7,
        (byte) 0xeb, (byte) 0x8c, (byte) 0xa1, 0x31, (byte) 0xf1, 0x65, 0x67,
        (byte) 0xc4, 0x45, (byte) 0xa9, 0x55, 0x51, 0x26, (byte) 0xd3, (byte) 0xc2, (byte) 0x9f,
        0x14, (byte) 0xe3, (byte) 0xd7, 0x76, (byte) 0xe8,
        0x41, (byte) 0xae, 0x74, 0x15};
    byte[] r = {
        0x39, 0x17, 0x6d, (byte) 0xac, 0x39, (byte) 0xac, (byte) 0xe4, (byte) 0x98, 0x0e,
        (byte) 0xcc, (byte) 0x8d, 0x77, (byte) 0x8e, (byte) 0x89,
        (byte) 0x86, 0x02, 0x55, (byte) 0xec, 0x36, 0x15, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
        0x00, 0x00, 0x00, 0x00
    };
    byte[] cm = {
        (byte) 0xcb, 0x3c, (byte) 0xf9, 0x15, 0x32, 0x70, (byte) 0xd5, 0x7e, (byte) 0xb9, 0x14,
        (byte) 0xc6, (byte) 0xc2, (byte) 0xbc, (byte) 0xc0,
        0x18, 0x50, (byte) 0xc9, (byte) 0xfe, (byte) 0xd4, 0x4f, (byte) 0xce, 0x08, 0x06, 0x27,
        (byte) 0x8f, 0x08, 0x3e, (byte) 0xf2,
        (byte) 0xdd, 0x07, 0x64, 0x39
    };
