...
import org.xbo.common.zksnark.LibrustzcashParam;
import org.xbo.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.xbo.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.xbo.common.zksnark.LibrustzcashParam.CheckSpendParams;
...
import org.xbo.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.xbo.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
import org.xbo.core.zen.address.DiversifierT;
import org.xbo.core.zen.address.ExpandedSpendingKey;
import org.xbo.core.zen.address.FullViewingKey;
...
import org.xbo.protos.Contract.SpendDescription;
...
public class ShieldedReceiveTest {
  ...
  private static final String ASSET_NAME = "xbo";
  private static final int XBO_NUM = 10;
  private static final int NUM = 1;
  private static final long START_TIME = 1;
  private static final long END_TIME = 2;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "XBO";
  ...
  private static byte[] randomUint256() {
    return org.xbo.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.xbo.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.xbo.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.xbo.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testDiversifierT() throws ZksnarkException {
    //byte[] data = org.xbo.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.xbo.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.xbo.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.xbo.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
   ...
   */
  @Test
  public void pushSameSkAndScanAndSpend() throws ContractValidateException,
      TooBigTransactionException, TooBigTransactionResultException, TaposException,
    ...
    byte[] memo = org.xbo.keystore.Wallet.generateRandomBytes(512);
    ...
    byte[] xboId = transactionCap.getTransactionId().getBytes();
    boolean ok = dbManager.pushTransaction(transactionCap);
    Assert.assertTrue(ok);
    ...
    for (int i = 0; i < notes1.getNoteTxsCount(); i++) {
      ...
      outPointBuild.setHash(ByteString.copyFrom(xboId));
    ...
    for (int i = 0; i < 1; i++) {
      org.xbo.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.xbo.keystore.Wallet.generateRandomBytes(512);
  ...
  public void decodePaymentAddressIgnoreCase() {
    String addressLower =
        "zxbo1975m0wyg8f30cgf2l5fgndhzqzkzgkgnxge8cwx2wr7m3q7chsuwewh2e6u24yykum0hq8ue99u";
