...
public class BandwidthProcessorTest {
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule xbo = new TransactionCapsule(transferAssetContract);
    ...
    org.xbo.protos.Protocol.Transaction.Contract contract = org.xbo.protos.Protocol.Transaction.Contract
        .newBuilder()
    ...
    long bytes = xbo.getSerializedSize();
  ...
  public void testFree() throws Exception {
    ...
    TransactionTrace trace = new TransactionTrace(xbo, dbManager);

    dbManager.consumeBandwidth(xbo, trace);
...
//    Assert.assertEquals(101220L, ret.getFee());
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = xbo.getInstance().toBuilder().clearRet().build().getSerializedSize() +
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule xbo = new TransactionCapsule(contract, dbManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(xbo, dbManager);
