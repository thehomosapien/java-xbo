...
public class WalletTestAssetIssue007 {
  ...
  private static final Integer xboNum = 1;
  ...
  public void testParticipateAssetIssueUseParticipateBandwidth() {
    ...
    Assert.assertTrue(PublicMethed
        .createAssetIssue(asset007Address, name, totalSupply, xboNum, icoNum, start, end, 1,
    ...
    Assert.assertTrue(beforeBalance - xboNum * 1 * icoNum >= afterBalance);
  }
