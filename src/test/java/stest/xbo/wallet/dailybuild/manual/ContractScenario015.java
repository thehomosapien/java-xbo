package stest.xbo.wallet.dailybuild.manual;
...
public class ContractScenario015 {
  ...
  @Test(enabled = true, description = "XBO TRC20 transfer token")
  public void trc20XBO() {
    ...
    String contractName = "XBO TRC20";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_Scenario015_TRC20_XBO");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_Scenario015_TRC20_XBO");
