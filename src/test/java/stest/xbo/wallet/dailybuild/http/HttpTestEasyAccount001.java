package stest.xbo.wallet.dailybuild.http;
...
import stest.xbo.wallet.common.client.utils.HttpMethed;
...
public class HttpTestEasyAccount001 {
  ...
  public void shutdown() throws InterruptedException {
    HttpMethed.freedResource(httpnode, Wallet.decodeFromBase58Check(generateAddress), fromAddress,
        generatePriKey);
