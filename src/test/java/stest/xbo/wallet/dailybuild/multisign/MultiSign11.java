...
import static org.xbo.api.GrpcAPI.Return.response_code.CONTRACT_VALIDATE_ERROR;
...
public class MultiSign11 {
  ...
  private final String contractXBODiceAddr = "TMYcx6eoRXnePKT1jVn25ZNeMNJ6828HWk";
  ...
  public void testActiveAddress02() {
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey) + "\",\"weight\":1},"
            + "{\"address\":\"" + contractXBODiceAddr + "\",\"weight\":1},"
            + "{\"address\":\"" + PublicMethed.getAddressString(testKey002)
            + "\",\"weight\":2147483647}]},"
            + "\"active_permissions\":[{\"type\":2,\"permission_name\":\"active0\",\"threshold\":2,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":["
            + "{\"address\":\"" + contractXBODiceAddr + "\",\"weight\":3},"
