package stest.xbo.wallet.dailybuild.tvmnewcommand.create2;
...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    //Trigger contract to transfer xbo and token.
  ...
  @Test(enabled = true, description = "Create2 contract can transfer xbo and token.")
