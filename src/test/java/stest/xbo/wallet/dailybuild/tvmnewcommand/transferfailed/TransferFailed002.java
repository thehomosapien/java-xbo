...
public class TransferFailed002 {
  ...
  @Test(enabled = true, description = "Send xbo nonexistent target")
  ...
  @Test(enabled = true, description = "Send xbo self")
  ...
  @Test(enabled = true, description = "Send xbo nonexistent target and balance not enough")
  ...
  @Test(enabled = true, description = "Send xbo self and balance not enough")
