...
public class TransferFailed005 {
  ...
  public void triggerContract01() {
    ...
    // transfer xbo to self`s account
    ...
    Assert.assertEquals("transfer xbo failed: Cannot transfer xbo to yourself.",
    ...
    // transfer xbo to unactivate account
    ...
    // transfer xbo to caller, value enough , function success contractResult(call_value) failed
    ...
    // transfer xbo to caller, value not enough, function success
