...
public class HttpMethed {
  ...
  public static HttpResponse assetIssue(String httpNode, byte[] ownerAddress, String name,
      String abbr, Long totalSupply, Integer xboNum, Integer num, Long startTime, Long endTime,
    ...
    try {
      ...
      userBaseObj2.addProperty("xbo_num", xboNum);
      ...
      if (shieldAddressInfo != null) {
        ...
        List shieldedSpends = Lists.newArrayList(
            new JSONObjectWarp()
                ...
                .put("alpha", ByteArray.toHexString(org.xbo.core.zen.note.Note.generateR()))
  ...
  public static HttpResponse sendShieldCoinWithoutAsk(String httpNode, String httpSolidityNode,
    ...
    try {
      ...
      if (shieldAddressInfo != null) {
        ...
        alpha = org.xbo.core.zen.note.Note.generateR();
